...
<html>
  <head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?= base_url('assets/adminlte/Font_Awesome/css/font-awesome.min.css') ?>">
    <!-- Ionicons -->
    <link rel="stylesheet" href="<?= base_url('assets/adminlte/ionicons/css/ionicons.css') ?>">
    <!-- Theme style -->
